...
public class ReplyController {
    ...
    public ResponseEntity<ReplyResponseDto> createReply(
        ...
        ReplyResponseDto responseDto = replyService.createReply(postId, requestDto, memberEmail);
    ...
    public ResponseEntity<ReplyResponseDto> updateReply(
        ...
        String memberEmail = userDetails.getUsername();
        ReplyResponseDto updatedReply = replyService.updateReply(replyId, requestDto, memberEmail);
    ...
    public ResponseEntity<Void> deleteReply(
        ...
        String memberEmail = userDetails.getUsername();
        replyService.deleteReply(replyId, memberEmail);
